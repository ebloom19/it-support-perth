  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-center">
        <p className="mb-4">Our customers say nice things about us and we are highly rated for IT support on Google Reviews. If you're a small or medium-sized business in Perth needing Managed IT support, network management, ad-hoc support or computer repairs, please call us up and kick the tyres.</p>
        <div className="flex justify-center items-center mb-4">
          <span className="text-3xl font-bold mr-2">4.6</span>
          <div className="flex">
            {[1, 2, 3, 4, 5].map((star) => (
              <Star key={star} className="w-6 h-6 text-yellow-400" fill={star <= 4 ? "currentColor" : "none"} />
            ))}
          </div>
          <span className="ml-2 text-gray-600">67 reviews</span>
        </div>
        <p className="mb-4">Don't trust hand-picked reviews on a website? All these reviews are available on our Google Business Page.</p>
