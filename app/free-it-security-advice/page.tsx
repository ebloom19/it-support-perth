        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <Card>
            <CardContent className="p-6">
              <CardTitle className="text-2xl mb-2 text-foreground">4.7 ★</CardTitle>
              <CardDescription className="text-muted-foreground">250+ Google Reviews</CardDescription>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6">
              <CardTitle className="text-2xl mb-2 text-foreground">Perth Based</CardTitle>
              <CardDescription className="text-muted-foreground">75B Brewer St, Perth</CardDescription>
            </CardContent>
          </Card>
        </div>
      </div>
