  ...
  const benefits = [
    {
      ...
      description:
        "FortiGate leverages FortiGuard Labs to identify and block threats using advanced ML",
      icon: Bot,
    ...
    },
    {
      ...
      description:
        "Reliable VPN solutions for secure remote work from anywhere",
      icon: Lock,
      color: "text-blue-500",
    },
    {
      ...
      description:
        "Full network visibility for monitoring traffic and enforcing policies",
      icon: Eye,
    ...
    },
    {
      ...
      description:
        "Solutions that scale effortlessly with your business growth",
      icon: LineChart,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-12">
              Your network is the backbone of your business. Our FortiGate
              Firewall Services provide comprehensive protection against
              advanced threats, ensuring your operations remain secure and
              efficient.
            </p>
          </div>
          ...
          <Card className="max-w-3xl mx-auto border-none bg-secondary">
            <CardContent className="pt-6">
              ...
              <p className="text-lg text-center text-muted-foreground mb-8">
                Protect your business with enterprise-grade FortiGate firewall
                solutions. Get started today and ensure your network is secure
