        ...
        <div className="md:col-span-2">
          <Card>
            <CardContent className="p-6 bg-white dark:bg-muted bg-opacity-80 rounded-lg">
              ...
              <div className="mt-6 flex space-x-4 border-b border-border pb-4 mb-4">
                <EmailShareButton
                  url={shareUrl}
                  subject={title}
                  body={description}
                >
                  <EmailIcon className="w-6 h-6 text-muted-foreground hover:text-foreground" />
                </EmailShareButton>
                <FacebookShareButton url={shareUrl} quote={title}>
                  <FacebookIcon className="w-6 h-6 text-muted-foreground hover:text-foreground" />
                </FacebookShareButton>
                ...
                <WhatsappShareButton url={shareUrl} title={title}>
                  <WhatsappIcon className="w-6 h-6 text-muted-foreground hover:text-foreground" />
                </WhatsappShareButton>
                <RedditShareButton url={shareUrl} title={title}>
                  <RedditIcon className="w-6 h-6 text-muted-foreground hover:text-foreground" />
                </RedditShareButton>
