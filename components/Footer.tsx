      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 text-foreground gap-6">
          ...
          <div className="flex flex-col gap-2 min-w-[200px]">
            ...
            <p>
              Phone:{' '}
              <a href="tel:0894638600" className="hover:text-foreground hover:underline">
                08 9463 8600
              </a>
            </p>
            <p>
          ...
          <div className="flex flex-col gap-2">
            ...
            {quickLinks.map((link, index) => (
              <Link
                key={index}
                href={link.path}
                className="text-sm md:text-base text-foreground hover:underline hover:text-foreground/80"
              >
                {link.name}
              </Link>
            ))}
